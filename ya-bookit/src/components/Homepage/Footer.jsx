...
const Section = ({ title, children }) => (
  <div>
    <h4 className="font-semibold text-white tracking-wide mb-4">{title}</h4>
...
const IconFacebook = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
      d="M22 12.06C22 6.49 17.52 2 12 2S2 6.49 2 12.06C2 17.06 5.66 21.2 10.44 22v-7.02H7.9v-2.92h2.54V9.41c0-2.5 1.49-3.88 3.77-3.88 1.09 0 2.23.2 2.23.2v2.45h-1.26c-1.24 0-1.63.77-1.63 1.56v1.88h2.78l-.44 2.92h-2.34V22C18.34 21.2 22 17.06 22 12.06Z"
      fill="currentColor"
    />
  </svg>
);
...
const IconInstagram = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
      d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5Zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7Zm5 3.5a5.5 5.5 0 1 1 0 11 5.5 5.5 0 0 1 0-11Zm0 2a3.5 3.5 0 1 0 0 7 3.5 3.5 0 0 0 0-7Zm5.75-.25a1.25 1.25 0 1 1 0-2.5 1.25 1.25 0 0 1 0 2.5Z"
      fill="currentColor"
    />
  </svg>
);
...
const IconX = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
      d="M3 3h3.6l5.04 6.9 5.52-6.9H21l-7.26 9.18L21 21h-3.6l-5.22-7.17L6.24 21H3l7.44-9.45L3 3Z"
      fill="currentColor"
    />
  </svg>
);
...
const IconYoutube = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
    <path
      d="M23 7.5s-.2-1.6-.8-2.3c-.8-.9-1.7-.9-2.1-1C17.6 4 12 4 12 4s-5.6 0-8.1.2c-.4.1-1.3.1-2.1 1C1.2 5.9 1 7.5 1 7.5S.8 9.5.8 11.4v1.3c0 1.9.2 3.9.2 3.9s.2 1.6.8 2.3c.8.9 1.9.8 2.4.9C6.3 19.9 12 20 12 20s5.6 0 8.1-.2c.4-.1 1.3-.1 2.1-1 .6-.7.8-2.3.8-2.3s.2-2 .2-3.9v-1.3c0-1.9-.2-3.9-.2-3.9ZM9.8 15.2v-6l6 3-6 3Z"
      fill="currentColor"
    />
  </svg>
);
